...
class CtrlViewInput:
    ...
    def try_id_player_input(self):
        ...
        try:
            return self.exception_input.except_invalid_format_id_player(
                id_player_tried)
    ...
    def try_alphanum_string_input(self, len_min=1, len_max=999):
        string_tried = input("Saisis : ")
        try:
            return self.exception_input.except_alphanum_min_max_characters(
                string_tried, len_min, len_max)
        except ValueError:
    ...
    def try_string_input(self, len_min=1, len_max=999):
        string_tried = input("Saisis : ")
        try:
            return self.exception_input.except_min_max_characters(
                string_tried, len_min, len_max)
        except NotEnoughCharacters:
            print(self.show_error_input.error_not_enough_characters(len_min))
            return self.try_string_input(len_min, len_max)
    ...
    def try_not_exists(self, type_item, input_given, result_check):
        ...
        try:
            ...
            print(self.show_error_input.error_not_exists(
                type_item, seek_input))
            return False
    ...
    def try_already_exists(self, type_item, input_given, result_check):
        ...
        try:
            ...
            print(self.show_error_input.error_already_exists(
                type_item, seek_input))
            return False
    ...
    def try_choice_input(self, list_given):
        ...
        try:
            return self.exception_input.except_unrecognized_input(
                choice_input, list_given)
        except ValueError:
            print(self.show_error_input.error_value_num_input())
